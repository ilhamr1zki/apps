        ...
        <div class="box-body table-responsive">
            ...
            <div class="row">
                ...
                <div class="col-sm-2" style="background-color: yellow;"> 
                    ...
                    <div class="form-group" style="background-color: #DE7A22; color: white; display: flex;height: 45px;padding: 15px 8px;width: 97%;">
                        <label> SPP </label>
                    </div>

                    <div class="form-group">
                        <label> JUN 21 </label>
                        <input type="text" value="0.00" name="">
                    </div>
                ...
                <div class="col-sm-2" style="background-color: yellow;"> 
                    ...
                    <div class="form-group" style="background-color: #DE7A22; color: white; display: flex;height: 45px;padding: 15px 8px;width: 97%;">
                        <br>
                        <label> TOTAL </label>
                        <input type="text" value="0.00" name="" style="margin-left: 10px;height: 23px;/*! padding-top: ; */margin-top: -4px;width: 95px;">
                    </div>
                ...
                <div class="col-sm-2" style="background-color: #F4CC70;"> 
                    
                    <div class="form-group" style="background-color: #DE7A22; color: white; display: flex;height: 45px;padding: 15px 8px;width: 97%;">
                        <label> Pangkal 2021 </label>
                    </div>
                ...
                <div class="col-sm-2" style="background-color: #E6DF44;"> 
                    
                    <div class="form-group" style="background-color: #DE7A22; color: white; display: flex;height: 45px;padding: 15px 8px;width: 97%;">
                        <label> Registrasi 2021 </label>
                    </div>
