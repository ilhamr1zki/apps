<?php $sqlJilid=mysqli_query($con,"select concat(tblall.nmjilid,' ', nmbagian) as nmjilidall, tblall.* from 
(
select tbl1.* from
...
<div class="box box-info">
    ...
    <div class="box-body table-responsive">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>Setting Manual Jilid</label>
