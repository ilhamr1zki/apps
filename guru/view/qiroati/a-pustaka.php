...
<div id="addpustaka" class="modal"  data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo $basegu; ?>a-guru/<?php echo md5('addpustaka'); ?>/access" method="post" enctype="multipart/form-data">
...
<div id="editpustaka" class="modal"  data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo $basegu; ?>a-guru/<?php echo md5('editpustaka'); ?>/access" method="post" enctype="multipart/form-data">
            <div class="modal-body">  
...
<div id="hapuspustaka" class="modal" data-bs-backdrop="static" data-bs-keyboard="false">
    ...
    <form action="<?php echo $basegu; ?>a-guru/<?php echo md5('hapuspustaka').'/access' ?>" method="post">
        <div class="modal-content">
