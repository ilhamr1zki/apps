<?php  
    ...
    if (isset($_POST['simpan_ubah_pw'])) {
        ...
        $dataPasswordLama   = mysqli_query($con, "SELECT * FROM guru WHERE c_guru = '$_SESSION[c_guru]' "); 
        ...
        if (password_verify($dataInputPasswordLama, $getPassword)) {
            ...
            if (strlen($dataInputPasswordBaru) < 5 || strlen($dataInputKonfirmasiPassword) < 5) {
                ...
                if ($dataInputPasswordBaru == $dataInputKonfirmasiPassword) {
                    ...
                    mysqli_query($con, "UPDATE guru SET password = '$generatePassword' WHERE c_guru = '$_SESSION[c_guru]' ");
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="password_lama" placeholder="password sekarang" id="password_lama">
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="password_baru" placeholder="Minimal 5 Karakter" id="password_baru">
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="konfirmasi_password_baru" placeholder="Minimal 5 Karakter" id="password_baru">
                    </div>
                </div>
