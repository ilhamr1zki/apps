          ...
          <div class="box box-info">
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
<?php 
$smk=mysqli_query($con,"SELECT * FROM siswa where c_kelas='$wali[c_kelas]' order by nama asc ");
$vr=1;
  while($akh=mysqli_fetch_array($smk))
    { 
      $csis=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM walimurid where c_siswa='$akh[c_siswa]' "));
?>                
                <tr>
                  <td><?php echo $vr; ?></td>
